<div class="modal fade" id="modal_8_opd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form_8_opd" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="risk_opd" id="risk_opd"></select>
                    </div>
                    <div class="form-group">
                        <label for="media">
                            Media/Bentuk Sarana
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnKomunikasiOpd" onclick="saveKomunikasiOpd()" class="btn btn-success">Simpan</button>
            </div>
        </div>
    </div>
</div>