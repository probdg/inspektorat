<div class="modal fade" id="modal_3c" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form_3c" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <!--begin::Form Group-->
                    <div class="form-group row">
                        <label for="kegiatan" class="font-size-h6 font-weight-bolder text-dark col-form-label col-12 ">
                            Kegiatan *
                        </label>
                        <div class="col-12">
                            <select name="kegiatan" id="kegiatan" class="form-control h-auto p-2 font-size-h6">
                            </select>
                        </div>
                    </div>
                    <!--end::Form Group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12">
                            <?php $tahapan = $this->db->get('ref_tahapan')->result(); ?>
                            <select name="tahapan" id="tahapan" class="form-control h-auto p-2 font-size-h6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12">
                            <select class="form-control" name="opd_penilai" id="opd_penilai" rows="3">
                                ...
                                <?php
                                $sumber = $this->db->order_by('id', 'asc')->get('ref_opd')->result();
                                foreach ($sumber as $row) : ?>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnSaveOperasional" onclick="saveRiskOperasional()" class="btn btn-success">Simpan</button>
            </div>
        </div>
    </div>
</div>