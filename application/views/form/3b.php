  <div class="form-group text-right">
      ...
      <button onclick="preview3b()" type="button" class="btn btn-danger font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3">
          <i class="far fa-file-pdf"></i>
          Preview Form 3.b Identifikasi Risiko Strategis OPD
      </button>
  </div>
  <!--begin::Form Group-->
  ...
  <div class="form-group row text-right">
      <div class="col-lg-12">
          <button type="button" id="btnRiskOpd" class="btn btn-warning font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3" onclick="addRiskOpd()">
  ...
  <div class="row">
      <div class="col-12">
          <table class="table table-bordered" id="tabel_3b">
              <thead>
                  <tr>
                      <th> NO</th>
                      <th> URAIAN RISIKO </th>
