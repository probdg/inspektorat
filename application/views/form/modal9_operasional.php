<div class="modal fade" id="modal_9_operasional" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form_9_operasional" novalidate="novalidate" enctype="multipart/form-data">
                    <input name="risk_operasional" type="text" style="display: none">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnPemantauanOperasional" onclick="savePemantauanOperasional()" class="btn btn-success">Simpan</button>
            </div>
        </div>
    </div>
</div>