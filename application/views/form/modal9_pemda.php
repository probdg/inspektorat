<div class="modal fade" id="modal_9_pemda" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form_9_pemda" novalidate="novalidate" enctype="multipart/form-data">
                    <input name="risk_pemda" type="text" style="display: none">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnPemantauanPemda" onclick="savePemantauanPemda()" class="btn btn-success">Simpan</button>
            </div>
        </div>
    </div>
</div>