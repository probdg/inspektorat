       <div class="modal fade" id="modal_risk_operasional_1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
           <div class="modal-dialog modal-xl modal-lg modal-dialog-centered" role="document">
               <div class="modal-content">
                   ...
                   <div class="modal-body">
                       <form id="form_pengelola_operasional_1" novalidate="novalidate" enctype="multipart/form-data">
                           ...
                           <!--end::Form Group-->
                           <div id="anggota_sop_1"></div>

                       </form>
                   </div>
                   <div class="modal-footer">
                       <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                       <button type="button" id="btnSaveSop1" onclick="save_sop_1()" class="btn btn-success">Simpan</button>
                   </div>
               </div>
           </div>
       </div>