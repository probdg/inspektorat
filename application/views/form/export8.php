    ...
    <h4 class="text-center">Pengkomunikasian Pengendalian Yang Dibangun </h4>
        ...
        <tbody>
            ...
            foreach ($risk_pemda as $risk_pemda) : ?>
                ...
                <tr>
                    ...
                    <td valign="top" align="left"><?= isset($risk_pemda['detail']) ? $risk_pemda['detail'][0]['media'] : '' ?></td>
                    <td valign="top" align="left"><?= isset($risk_pemda['detail']) ? $risk_pemda['detail'][0]['penyedia_informasi'] : '' ?></td>
                    <td valign="top" align="center"><?= isset($risk_pemda['detail']) ? $risk_pemda['detail'][0]['penerima_informasi'] : '' ?></td>
                    <td valign="top" align="left"><?= isset($risk_pemda['detail']) ? $risk_pemda['detail'][0]['rencana_waktu_pelaksanaan'] : '' ?></td>
                    <td valign="top" align="left"><?= isset($risk_pemda['detail']) ? $risk_pemda['detail'][0]['realisasi_waktu_pelaksanaan'] : '' ?></td>
                ...
                <?php if ($jumlah > 1) : ?> <?php for ($i = 1; $i < $jumlah; $i++) : ?>
                        <tr>
                            ...
                            <td valign="top" align="left"><?= isset($risk_pemda['detail']) ? $risk_pemda['detail'][$i]['media'] : '' ?></td>
                            <td valign="top" align="left"><?= isset($risk_pemda['detail']) ? $risk_pemda['detail'][$i]['penyedia_informasi'] : '' ?></td>
                            <td valign="top" align="center"><?= isset($risk_pemda['detail']) ? $risk_pemda['detail'][$i]['penerima_informasi'] : '' ?></td>
                            <td valign="top" align="left"><?= isset($risk_pemda['detail']) ? $risk_pemda['detail'][$i]['rencana_waktu_pelaksanaan'] : '' ?></td>
                            <td valign="top" align="left"><?= isset($risk_pemda['detail']) ? $risk_pemda['detail'][$i]['realisasi_waktu_pelaksanaan'] : '' ?></td>
                ...
                <?php if ($value['detail_risiko']) : ?>
                    ...
                    foreach ($value['detail_risiko'] as $detail) : ?>
                        ...
                        <tr>
                            ...
                            <td valign="top" align="left"><?= isset($detail['detail']) ? $detail['detail'][0]['media'] : '' ?></td>
                            <td valign="top" align="left"><?= isset($detail['detail']) ? $detail['detail'][0]['penyedia_informasi'] : '' ?></td>
                            <td valign="top" align="center"><?= isset($detail['detail']) ? $detail['detail'][0]['penerima_informasi'] : '' ?></td>
                            <td valign="top" align="left"><?= isset($detail['detail']) ? $detail['detail'][0]['rencana_waktu_pelaksanaan'] : '' ?></td>
                            <td valign="top" align="left"><?= isset($detail['detail']) ? $detail['detail'][0]['realisasi_waktu_pelaksanaan'] : '' ?></td>
                        ...
                        <?php if ($jopd > 1) : ?> <?php for ($iopd = 1; $iopd < $jopd; $iopd++) : ?>
                                <tr>
                                    ...
                                    <td valign="top" align="left"><?= isset($detail['detail']) ? $detail['detail'][$iopd]['media'] : '' ?></td>
                                    <td valign="top" align="left"><?= isset($detail['detail']) ? $detail['detail'][$iopd]['penyedia_informasi'] : '' ?></td>
                                    <td valign="top" align="center"><?= isset($detail['detail']) ? $detail['detail'][$iopd]['penerima_informasi'] : '' ?></td>
                                    <td valign="top" align="left"><?= isset($detail['detail']) ? $detail['detail'][$iopd]['rencana_waktu_pelaksanaan'] : '' ?></td>
                                    <td valign="top" align="left"><?= isset($detail['detail']) ? $detail['detail'][$iopd]['realisasi_waktu_pelaksanaan'] : '' ?></td>
                ...
                <?php if ($value['detail_risiko']) : ?>
                    ...
                    foreach ($value['detail_risiko'] as $detail_op) : ?>
                        ...
                        <tr>
                            ...
                            <td valign="top" align="left"><?= isset($detail_op['detail']) ? $detail_op['detail'][0]['media'] : '' ?></td>
                            <td valign="top" align="left"><?= isset($detail_op['detail']) ? $detail_op['detail'][0]['penyedia_informasi'] : '' ?></td>
                            <td valign="top" align="center"><?= isset($detail_op['detail']) ? $detail_op['detail'][0]['penerima_informasi'] : '' ?></td>
                            <td valign="top" align="left"><?= isset($detail_op['detail']) ? $detail_op['detail'][0]['rencana_waktu_pelaksanaan'] : '' ?></td>
                            <td valign="top" align="left"><?= isset($detail_op['detail']) ? $detail_op['detail'][0]['realisasi_waktu_pelaksanaan'] : '' ?></td>
                        ...
                        <?php if ($joper > 1) : ?> <?php for ($ioper = 1; $ioper < $joper; $ioper++) : ?>
                                <tr>
                                    ...
                                    <td valign="top" align="left"><?= isset($detail_op['detail']) ? $detail_op['detail'][$ioper]['media'] : '' ?></td>
                                    <td valign="top" align="left"><?= isset($detail_op['detail']) ? $detail_op['detail'][$ioper]['penyedia_informasi'] : '' ?></td>
                                    <td valign="top" align="center"><?= isset($detail_op['detail']) ? $detail_op['detail'][$ioper]['penerima_informasi'] : '' ?></td>
                                    <td valign="top" align="left"><?= isset($detail_op['detail']) ? $detail_op['detail'][$ioper]['rencana_waktu_pelaksanaan'] : '' ?></td>
                                    <td valign="top" align="left"><?= isset($detail_op['detail']) ? $detail_op['detail'][$ioper]['realisasi_waktu_pelaksanaan'] : '' ?></td>
