<div class="modal fade" id="modal_form_aktifitas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form_aktifitas" novalidate="novalidate" enctype="multipart/form-data">
                    <input name="opd_id" type="text" value="<?= $idOpd ?>" style="display: none">
                    <input name="tahun" type="text" class="tahun" style="display: none">
                    <input name="id_aktifitas" type="text" style="display: none">
                    <!--begin::Form Group-->
                    ...
                    <div class="form-group row">
                        <label for="aktifitas" class="col-form-label col-12">
                            Aktifitas
                        </label>
                        <div class="col-12">
                            <textarea class="form-control" name="aktifitas" id="aktifitas" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
