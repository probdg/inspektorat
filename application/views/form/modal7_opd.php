<div class="modal fade" id="modal_7_opd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form_7_opd" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnPengendalianOpd" onclick="savePengendalianOpd()" class="btn btn-success">Simpan</button>
            </div>
        </div>
    </div>
</div>