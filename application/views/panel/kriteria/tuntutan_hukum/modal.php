        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="form-group row validated">
                        <label for="tuntutan_hukum" class="col-4 col-form-label">Tuntutan Hukum</label>
                        <div class="col-8">
                            <textarea name="tuntutan_hukum" type="text" class='form-control' placeholder="" style="width: 100%;" required></textarea>
                        </div>
                    </div>
                    <div class="form-group row validated">
