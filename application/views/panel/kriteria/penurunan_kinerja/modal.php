        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="form-group row validated">
                        <label for="penurunan_kinerja" class="col-4 col-form-label">Penurunan Kinerja</label>
                        <div class="col-8">
                            <textarea name="penurunan_kinerja" type="text" class='form-control' placeholder="" style="width: 100%;" required></textarea>
                        </div>
                    </div>
                    <div class="form-group row validated">
