<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#tabel').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('kriteria/kategori_risiko/dat_list') ?>',
                "type": "POST",
    ...
    async function edit(id) {
        ...
        await $.ajax({
            url: '<?= base_url('kriteria/kategori_risiko/edit/') ?>' + id,
            type: "GET",
            async: false,
            dataType: "JSON",
            success: function(data) {
                ...
                $('.modal-title').text('Edit Kategori Risiko'); // Set title to Bootstrap modal title
            },
    ...
    function save() {
        ...
        var url;
        url = '<?= base_url('kriteria/kategori_risiko/save') ?>';
    ...
    function _delete(id, nama) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?= base_url('kriteria/kategori_risiko/delete/') ?>' + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
