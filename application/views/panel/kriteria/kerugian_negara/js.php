<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#tabel').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('kriteria/kerugian_negara/dat_list') ?>',
                "type": "POST",
    ...
    async function edit(id) {
        ...
        await $.ajax({
            url: '<?= base_url('kriteria/kerugian_negara/edit/') ?>' + id,
            type: "GET",
            async: false,
            dataType: "JSON",
            success: function(data) {
                ...
                $('[name="kerugian_negara"]').val(data.kerugian_negara);

                $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
                $('.modal-title').text('Edit Kriteria Kerugian Negara'); // Set title to Bootstrap modal title
            },
    ...
    function save() {
        ...
        var url;
        url = '<?= base_url('kriteria/kerugian_negara/save') ?>';
    ...
    function _delete(id, nama) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?= base_url('kriteria/kerugian_negara/delete/') ?>' + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
