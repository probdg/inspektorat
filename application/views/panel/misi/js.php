    ...
    async function edit(id) {
        ...
        await $.ajax({
            ...
            success: function(data) {
                ...
                $('.modal-title').text('Edit Misi Strategis'); // Set title to Bootstrap modal title
            },
