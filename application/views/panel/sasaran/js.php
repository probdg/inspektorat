<script type="text/javascript">
    ...
    async function edit(id) {
        ...
        await $.ajax({
            ...
            success: function(data) {
                ...
                $('.modal-title').text('Edit Sasaran Strategis'); // Set title to Bootstrap modal title
            },
    ...
    function _delete(id, nama) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?= base_url('sasaran/delete/') ?>' + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
