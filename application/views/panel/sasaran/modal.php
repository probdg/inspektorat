        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="form-group row validated">
                        <label for="no_urut" class="col-4 col-form-label">No Urut</label>
                        <div class="col-8">
                    ...
                    <div class="form-group row validated">
                        ...
                        <div class="col-8">
                            <textarea name="sasaran" type="text" class='form-control' placeholder="" style="width: 100%;" required></textarea>
                        </div>
                    </div>
                </form>
            </div>
