    ...
    async function edit(id) {
        ...
        await $.ajax({
            ...
            success: function(data) {
                ...
                $('[name="from"]').val(data.periode_awal);
                $('[name="to"]').val(data.periode_akhir);
                $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
                $('.modal-title').text('Edit RPJMD'); // Set title to Bootstrap modal title
            },
