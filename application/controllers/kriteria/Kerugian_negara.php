...
class Kerugian_negara extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'subtitle' => 'Kriteria Kerugian Negara',
            'sess_opd'  => $this->session->userdata('opd'),
            'namaPemda' => $namaPemda,
            'idPemda'   => $idPemda,
            'content'   => 'panel/kriteria/kerugian_negara/index',
            'js'        => 'panel/kriteria/kerugian_negara/js',
    ...
    {
        $tabel = 'ref_kerugian_negara';
        $column_order = array(null, 'kerugian_negara');
        $coloumn_search = array('kerugian_negara');
    ...
    {
        $kerugian_negara = $this->input->post('kerugian_negara', TRUE);
        ...
        $config = [
            [
                'field' => 'kerugian_negara',
                'rules' => 'required',
                'errors' => [
                    'required' => 'Masukan Kriteria Kerugian Negara',
                ],
            ],
            [
                'field' => 'level_dampak',
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($id) {
                $this->db->update('ref_kerugian_negara', $data, ['id' => $id]);
                $msg = 'Data berhasil diperbaharui';
            } else {
                $this->db->insert('ref_kerugian_negara', $data);
    ...
    {
        $row = $this->db->get_where('ref_kerugian_negara', ['id' => $id])->row();
        echo json_encode($row);
    }

    public function delete($id)
    {
        $delete = $this->db->delete('ref_kerugian_negara', ['id' => $id]);
        if ($delete) {
