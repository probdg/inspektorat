...
class Sumber_risiko extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'subtitle' => 'Kriteria Sumber Risiko',
            'sess_opd'  => $this->session->userdata('opd'),
            'namaPemda' => $namaPemda,
            'idPemda'   => $idPemda,
            'content'   => 'panel/kriteria/sumber_risiko/index',
            'js'        => 'panel/kriteria/sumber_risiko/js',
    ...
    public function save()
    {
        ...
        $config = [
            [
                ...
                'rules' => 'required',
                'errors' => [
                    'required' => 'Masukan kategori sumber risiko',
                ],
            ],
            [
                'field' => 'reg',
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($id) {
                $this->db->update('ref_sumber_risiko', $data, ['id' => $id]);
                $msg = 'Data berhasil diperbaharui';
            } else {
                $this->db->insert('ref_sumber_risiko', $data);
    ...
    {
        $row = $this->db->get_where('ref_sumber_risiko', ['id' => $id])->row();
        echo json_encode($row);
    }

    public function delete($id)
    {
        $delete = $this->db->delete('ref_sumber_risiko', ['id' => $id]);
        if ($delete) {
